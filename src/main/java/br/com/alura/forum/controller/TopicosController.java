...
public class TopicosController {
	...
	public Page<TopicoDto> lista(@RequestParam(required = false) String nomeCurso, 
			@RequestParam(required = true) int pagina, @RequestParam(required = true) int qtd, @RequestParam(required = true) String ordenacao) {
	...
	@PutMapping("/{id}")
	@Transactional //faz o commit no final deste método
